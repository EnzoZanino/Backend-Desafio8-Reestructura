// import name from "../../routes/LoginAndRegister/sessions.router.js"
...
let currentUserEmail; // aca una vez que entramos por primera vez a la vista de cart, nos crea un cart vacio del email corriente (ultimo logeado)
                      // sino desde realTimeProducts.js si hago un push al cart (addToCart) 
...
async function updateUserEmailContainer() {
    try {
        ...
        userEmailContainer.innerText = 'Usuario: ' + data.email;
